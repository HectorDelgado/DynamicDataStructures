#
# Be sure to run `pod lib lint DynamicDataStructures.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
"A series of implementations of various data structures in Swift."
                       DESC
  ...
  s.source_files = 'DynamicDataStructures/Classes/**/*'
  
  # s.resource_bundles = {
  #   'DynamicDataStructures' => ['DynamicDataStructures/Assets/*.png']
  # }
